...
We find that the piezo callibration is a a function of the peak to peak driving voltages. This is likely due to some sort of non-linear response in the controller piezo stack. Ideally, this calibration would be constant and independent of all variables that may change in the experiment. In general, we find that the callibration is significantly lower than ThorLabs specification
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ1MTIzMTE4OSwtMTYxOTA2NTI0LC0xNz
