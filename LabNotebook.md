...
*We chose to try to find the periodicity of the the graph by taking the fast fourier transform (FFT) of the data and finding the fundamental frequencies.* 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYxMzExNDQyMCwxNzQ4MzMzMjQ5LC04MT
