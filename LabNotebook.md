...
This part is slightly trickier we had to orient the second mirror, $M_2$, so that the reflected spot was far enough from the incident so that we could measure it separately. This was more difficult because the cavity lngth at the time was only about 15cm  We also had to move on of the other mirrors in the setup so we retook the $M_2$ measurement data. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzAwMjAzODU0LC0xNTAyNjk4OTEwLDEzOD
